...
var matchHornToBody			: boolean				= true;
...
function CheckHornToBody(){
	if (thisMaterial.GetProceduralFloat("HornHue") != bodyMaterial.GetProceduralFloat("BodyHue"))
	{
		thisMaterial.SetProceduralFloat("HornHue", bodyMaterial.GetProceduralFloat("BodyHue"));
		rebuildTextures		= true;
	}
	if (thisMaterial.GetProceduralFloat("HornSaturation") != bodyMaterial.GetProceduralFloat("BodySaturation"))
	{
		thisMaterial.SetProceduralFloat("HornSaturation", bodyMaterial.GetProceduralFloat("BodySaturation"));
		rebuildTextures		= true;
	}
	if (thisMaterial.GetProceduralFloat("HornLightness") != bodyMaterial.GetProceduralFloat("BodyLightness"))
	{
		thisMaterial.SetProceduralFloat("HornLightness", bodyMaterial.GetProceduralFloat("BodyLightness"));
		rebuildTextures		= true;
	}
	if (thisMaterial.GetProceduralFloat("HornContrast") != bodyMaterial.GetProceduralFloat("BodyContrast"))
	{
		thisMaterial.SetProceduralFloat("HornContrast", bodyMaterial.GetProceduralFloat("BodyContrast"));
		rebuildTextures		= true;
	}
	if (thisMaterial.GetProceduralFloat("HornOverlayAO") != bodyMaterial.GetProceduralFloat("BodyOverlayAO"))
	{
		thisMaterial.SetProceduralFloat("HornOverlayAO", bodyMaterial.GetProceduralFloat("BodyOverlayAO"));
		rebuildTextures		= true;
	}
	if (thisMaterial.GetProceduralFloat("HornOverlayBlend") != bodyMaterial.GetProceduralFloat("BodyOverlayBlend"))
	{
		thisMaterial.SetProceduralFloat("HornOverlayBlend", bodyMaterial.GetProceduralFloat("BodyOverlayBlend"));
		rebuildTextures		= true;
	}
	if (thisMaterial.GetProceduralFloat("HornRoughnessShift") != bodyMaterial.GetProceduralFloat("BodyRoughnessShift"))
	{
		thisMaterial.SetProceduralFloat("HornRoughnessShift", bodyMaterial.GetProceduralFloat("BodyRoughnessShift"));
		rebuildTextures		= true;
	}
	if (thisMaterial.GetProceduralColor("HornOverlayColor") != bodyMaterial.GetProceduralColor("BodyOverlayColor"))
	{
		thisMaterial.SetProceduralColor("HornOverlayColor", bodyMaterial.GetProceduralColor("BodyOverlayColor"));
		rebuildTextures		= true;
	}
}

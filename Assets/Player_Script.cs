...
public class Player_Script : MonoBehaviour {
	...
	public enum playerGenders {Male, Female};
	playerGenders pGender;

	public playerGenders Gender {
		get {
			return pGender;
		}
		set {
			pGender = value;
			//Gender change code here
		}
	}

	public enum playerClasses {Warrior, Rogue, Mage};
	playerClasses pClass;

	public playerClasses PClass {
		get {
			return pClass;
		}
		set {
